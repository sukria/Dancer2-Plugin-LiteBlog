...
a:hover {
    color: #0056b3; /* Darker shade of blue for hover state */
}
...
<body>
    ...
    <header id="mobile-header">
        <div id="avatar-icon">
            <!-- TODO : avatar should be a setting with these as defaults -->
    ...
    [% IF page_title %]
    <!-- single-page layout -->
    <section id="hero" class="hero-single-page">
    [% ELSE %]
    <section id="hero">
    [% END %]
    ...
    [% IF page_title %]
        <div class="hero-title-single-page">
            <h1 class="hero-title-text">[% page_title %]</h1>
        </div>
    [% END %]
    </section>
